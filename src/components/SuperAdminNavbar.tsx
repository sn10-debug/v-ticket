...
export default function SuperAdminNavbarComponent() {
    ...
    const routes = [
        ...
        {
            name: "Create event",
            link: "/super-admin/add-an-event",
        },
        {
            name: "Bulk upload",
            link: "/super-admin/upload",
        },
        {
            name: "View database",
        ...
        {
            name: "Manage staff and admins",
            link: "/super-admin/admins",
        },
        {
            name: "Edit entries",
            link: "/super-admin/edit",
        },
        {
            name: "Tickets",
